...
komisje <- read.csv("ws2007_komisje_wyniki.csv", 
...
showVotes(komisje, "LiDp", "LiD", region, kN, minTurnout);
showVotes(komisje, "Samoobronap", "SRp", region, kN, minTurnout);
